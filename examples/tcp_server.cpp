...
class MyServer : public TCPServer<MySession>
{
public:
...
protected:
    ...
    void onAccepted(const TSession& session) override { std::cout << "MyServer new session is accepted!" << std::endl; }
...
class MySession : public TCPSession<MyServer>
{
public:
