...
inline TCPSession<TServer, TSession>::TCPSession(TServer& server, const CppCommon::UUID& uuid, asio::ip::tcp::socket socket) : _server(server), _id(uuid), _socket(std::move(socket))
{
